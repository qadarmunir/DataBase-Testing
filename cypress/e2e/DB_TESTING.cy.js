describe('Example to Demonstrate SQL Database Testing in Cypress', () => {
  ...
  //   (005, "Micha", "House No. 05", "Vant");`).then((result) => {
  ...
  it.skip('Update an Entry into the table and verify', function () {
